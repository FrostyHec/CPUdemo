...
void Vcounter::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+4,"counter out", false,-1, 7,0);
        tracep->declBus(c+5,"counter count_reg", false,-1, 7,0);
        tracep->declBus(c+6,"counter next_count_reg", false,-1, 7,0);
    }
}
...
void Vcounter::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+4,(vlTOPp->out),8);
        tracep->fullCData(oldp+5,(vlTOPp->counter__DOT__count_reg),8);
        tracep->fullCData(oldp+6,(vlTOPp->counter__DOT__next_count_reg),8);
    }
}

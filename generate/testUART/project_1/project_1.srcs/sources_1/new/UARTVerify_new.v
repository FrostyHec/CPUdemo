module UART_1(
  ...
  wire  uart_clock; // @[UART.scala 30:22]
  ...
  assign uart_clock = clock; // @[UART.scala 31:19]
  assign uart_rst = reset; // @[UART.scala 32:17]
...
`endif // RANDOMIZE_REG_INIT
  ...
  UART_1 uart ( // @[UARTVerify.scala 14:18]
    .clock(uart_clock),
    .reset(uart_reset),
  ...
  assign io_led = uart_io_mmio_rxData;//out_led; // @[UARTVerify.scala 22:9]

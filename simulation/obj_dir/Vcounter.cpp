...
VL_INLINE_OPT void Vcounter::_sequent__TOP__1(Vcounter__Syms* __restrict vlSymsp) {
    ...
    Vcounter* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->counter__DOT__count_reg = ((IData)(vlTOPp->rst)
                                        ? 0U : (IData)(vlTOPp->counter__DOT__next_count_reg));
}

VL_INLINE_OPT void Vcounter::_settle__TOP__2(Vcounter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter::_settle__TOP__2\n"); );
    Vcounter* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->counter__DOT__next_count_reg = (0xffU & 
                                            ((IData)(vlTOPp->en)
                                              ? ((IData)(1U) 
                                                 + (IData)(vlTOPp->counter__DOT__count_reg))
                                              : (IData)(vlTOPp->counter__DOT__count_reg)));
    vlTOPp->out = vlTOPp->counter__DOT__next_count_reg;
}

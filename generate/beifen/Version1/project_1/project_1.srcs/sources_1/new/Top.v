...
`endif // RANDOMIZE_REG_INIT
  reg [31:0] btn; // @[OutRegisters.scala 24:20]
  reg [31:0] switches; // @[OutRegisters.scala 27:25]
  reg [31:0] led; // @[OutRegisters.scala 31:20]
  reg [31:0] seg7; // @[OutRegisters.scala 34:21]
  wire [31:0] addr = io_mem_write ? io_mem_write_addr : io_mem_read_addr; // @[OutRegisters.scala 38:23]
  wire  _T_1 = addr == 32'h3fffffc1; // @[OutRegisters.scala 41:13]
  wire  _T_3 = ~reset; // @[OutRegisters.scala 43:13]
  wire  _T_5 = addr == 32'h3fffffc2; // @[OutRegisters.scala 47:19]
  wire [31:0] _GEN_2 = io_mem_write ? io_mem_write_data : led; // @[OutRegisters.scala 54:24 55:11 31:20]
  wire [31:0] _GEN_4 = io_mem_write ? io_mem_write_data : seg7; // @[OutRegisters.scala 60:24 61:12 34:21]
  wire [31:0] _GEN_6 = addr == 32'h3fffffc3 ? _GEN_4 : seg7; // @[OutRegisters.scala 34:21 59:65]
  wire [31:0] _GEN_9 = addr == 32'h3fffffc0 ? led : seg7; // @[OutRegisters.scala 53:64]
  wire [31:0] _GEN_11 = addr == 32'h3fffffc2 ? switches : _GEN_9; // @[OutRegisters.scala 47:67]
  assign io_mem_read_data = addr == 32'h3fffffc1 ? btn : _GEN_11; // @[OutRegisters.scala 41:58]
  assign io_external_led_led = led; // @[OutRegisters.scala 32:23]
  assign io_external_seg7_seg7 = seg7; // @[OutRegisters.scala 35:25]
  always @(posedge clock) begin
    if (reset) begin // @[OutRegisters.scala 24:20]
      btn <= 32'h0; // @[OutRegisters.scala 24:20]
    end else begin
      btn <= io_external_btn_button; // @[OutRegisters.scala 25:7]
    end
    if (reset) begin // @[OutRegisters.scala 27:25]
      switches <= 32'h0; // @[OutRegisters.scala 27:25]
    end else begin
      switches <= io_external_switches_switches; // @[OutRegisters.scala 28:12]
    end
    if (reset) begin // @[OutRegisters.scala 31:20]
      led <= 32'h0; // @[OutRegisters.scala 31:20]
    end else if (!(addr == 32'h3fffffc1)) begin // @[OutRegisters.scala 41:58]
      if (!(addr == 32'h3fffffc2)) begin // @[OutRegisters.scala 47:67]
        if (addr == 32'h3fffffc0) begin // @[OutRegisters.scala 53:64]
          led <= _GEN_2;
        end
      end
    end
    if (reset) begin // @[OutRegisters.scala 34:21]
      seg7 <= 32'h0; // @[OutRegisters.scala 34:21]
    end else if (!(addr == 32'h3fffffc1)) begin // @[OutRegisters.scala 41:58]
      if (!(addr == 32'h3fffffc2)) begin // @[OutRegisters.scala 47:67]
        if (!(addr == 32'h3fffffc0)) begin // @[OutRegisters.scala 53:64]
          seg7 <= _GEN_6;
    ...
    `endif
        if (_T_1 & io_mem_write & ~reset) begin
          $fwrite(32'h80000002,"btn cannot write"); // @[OutRegisters.scala 43:13]
        end
    `ifdef PRINTF_COND
      end
    `endif
    ...
    `endif
        if (~_T_1 & _T_5 & io_mem_write & _T_3) begin
          $fwrite(32'h80000002,"switches cannot write"); // @[OutRegisters.scala 49:13]
        end
    `ifdef PRINTF_COND
      end
    `endif
...
module UARTLoader(
  input         clock,
  input         reset,
  (* MARK_DEBUG="true" *)input  [1:0]  io_cpu_state,
  (* MARK_DEBUG="true" *)input         io_rxValid,
  (* MARK_DEBUG="true" *)input  [7:0]  io_rxData,
  (* MARK_DEBUG="true" *)output        io_rxReady,
  (* MARK_DEBUG="true" *)output        io_mem_mem_write,
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_2;
`endif // RANDOMIZE_REG_INIT
  reg [1:0] cur_state; // @[UARTLoader.scala 34:26]
  reg [31:0] data_addr; // @[UARTLoader.scala 35:26]
  reg  rxReadyReg; // @[UARTLoader.scala 44:27]
  wire  _T_3 = io_cpu_state != 2'h2; // @[UARTLoader.scala 57:25]
  wire [1:0] _GEN_2 = ~io_rxValid ? 2'h3 : cur_state; // @[UARTLoader.scala 60:38 61:21 34:26]
  wire [31:0] _data_addr_T_1 = data_addr + 32'h1; // @[UARTLoader.scala 71:34]
  wire [31:0] _GEN_4 = io_rxValid ? _data_addr_T_1 : data_addr; // @[UARTLoader.scala 70:37 71:21 35:26]
  wire [1:0] _GEN_5 = io_rxValid ? 2'h2 : cur_state; // @[UARTLoader.scala 70:37 72:21 34:26]
  wire [1:0] _GEN_6 = _T_3 ? 2'h0 : _GEN_5; // @[UARTLoader.scala 67:61 68:19]
  wire [31:0] _GEN_7 = _T_3 ? data_addr : _GEN_4; // @[UARTLoader.scala 35:26 67:61]
  wire [1:0] _GEN_9 = io_rxValid ? cur_state : 2'h3; // @[UARTLoader.scala 34:26 81:37 85:21]
  wire [1:0] _GEN_10 = _T_3 ? 2'h0 : _GEN_9; // @[UARTLoader.scala 78:61 79:19]
  wire  _GEN_11 = _T_3 ? 1'h0 : io_rxValid; // @[UARTLoader.scala 42:20 78:61]
  wire  _GEN_12 = 2'h2 == cur_state ? _GEN_11 : rxReadyReg; // @[UARTLoader.scala 47:21 44:27]
  wire [1:0] _GEN_13 = 2'h2 == cur_state ? _GEN_10 : cur_state; // @[UARTLoader.scala 47:21 34:26]
  wire  _GEN_18 = 2'h3 == cur_state ? 1'h0 : 2'h2 == cur_state & _GEN_11; // @[UARTLoader.scala 42:20 47:21]
  wire  _GEN_22 = 2'h1 == cur_state ? 1'h0 : _GEN_18; // @[UARTLoader.scala 42:20 47:21]
  assign io_rxReady = rxReadyReg; // @[UARTLoader.scala 45:13]
  assign io_mem_mem_write = 2'h0 == cur_state ? 1'h0 : _GEN_22; // @[UARTLoader.scala 42:20 47:21]
  assign io_mem_data_to_write = {{24'd0}, io_rxData}; // @[UARTLoader.scala 40:24]
  assign io_mem_data_addr = data_addr; // @[UARTLoader.scala 38:20]
  always @(posedge clock) begin
    if (reset) begin // @[UARTLoader.scala 34:26]
      cur_state <= 2'h0; // @[UARTLoader.scala 34:26]
    end else if (2'h0 == cur_state) begin // @[UARTLoader.scala 47:21]
      if (io_cpu_state == 2'h2) begin // @[UARTLoader.scala 50:61]
        cur_state <= 2'h1; // @[UARTLoader.scala 52:19]
      end
    end else if (2'h1 == cur_state) begin // @[UARTLoader.scala 47:21]
      if (io_cpu_state != 2'h2) begin // @[UARTLoader.scala 57:61]
        cur_state <= 2'h0; // @[UARTLoader.scala 58:19]
      end else begin
        cur_state <= _GEN_2;
      end
    end else if (2'h3 == cur_state) begin // @[UARTLoader.scala 47:21]
      cur_state <= _GEN_6;
    end else begin
      cur_state <= _GEN_13;
    end
    if (reset) begin // @[UARTLoader.scala 35:26]
      data_addr <= 32'hffffffff; // @[UARTLoader.scala 35:26]
    end else if (2'h0 == cur_state) begin // @[UARTLoader.scala 47:21]
      if (io_cpu_state == 2'h2) begin // @[UARTLoader.scala 50:61]
        data_addr <= 32'hffffffff; // @[UARTLoader.scala 51:19]
      end
    end else if (!(2'h1 == cur_state)) begin // @[UARTLoader.scala 47:21]
      if (2'h3 == cur_state) begin // @[UARTLoader.scala 47:21]
        data_addr <= _GEN_7;
      end
    end
    if (reset) begin // @[UARTLoader.scala 44:27]
      rxReadyReg <= 1'h0; // @[UARTLoader.scala 44:27]
    end else if (2'h0 == cur_state) begin // @[UARTLoader.scala 47:21]
      rxReadyReg <= 1'h0; // @[UARTLoader.scala 49:17]
    end else if (2'h1 == cur_state) begin // @[UARTLoader.scala 47:21]
      rxReadyReg <= 1'h0; // @[UARTLoader.scala 56:17]
    end else if (2'h3 == cur_state) begin // @[UARTLoader.scala 47:21]
      rxReadyReg <= 1'h0; // @[UARTLoader.scala 66:17]
    end else begin
      rxReadyReg <= _GEN_12;
    end
  end
...
module CoreTop(
  ...
  output        io_external_uart_rxReady,
  ...
  wire  uartLoader_io_rxReady; // @[CoreTop.scala 21:26]
  ...
  wire [2:0] writeDataSelector_io_write_back_type; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_imm; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_mem_out; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_au_out; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_pc4; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_pcImm; // @[CoreTop.scala 59:33]
  wire [31:0] writeDataSelector_io_write_data; // @[CoreTop.scala 59:33]
  wire  auSelector_io_au_type; // @[CoreTop.scala 60:26]
  wire [31:0] auSelector_io_alu_result; // @[CoreTop.scala 60:26]
  wire  auSelector_io_cmp_result; // @[CoreTop.scala 60:26]
  wire [31:0] auSelector_io_au_out; // @[CoreTop.scala 60:26]
  ...
  UARTLoader uartLoader ( // @[CoreTop.scala 21:26]
    ...
    .io_rxReady(uartLoader_io_rxReady),
  ...
  WriteDataSelector writeDataSelector ( // @[CoreTop.scala 59:33]
  ...
  AUSelector auSelector ( // @[CoreTop.scala 60:26]
  ...
  assign io_external_led_led = memory_io_external_led_led; // @[CoreTop.scala 127:22]
  assign io_external_seg7_seg7 = memory_io_external_seg7_seg7; // @[CoreTop.scala 127:22]
  assign io_external_uart_rxReady = state_io_cpu_state == 2'h2 & uartLoader_io_rxReady; // @[CoreTop.scala 127:22 147:60 150:29]
  assign memory_clock = clock;
  assign memory_reset = reset;
  assign memory_io_cpu_state = state_io_cpu_state; // @[CoreTop.scala 120:23]
  assign memory_io_ins_addr = pc_io_addr; // @[CoreTop.scala 68:22]
  assign memory_io_write_data = memInSelector_io_write_data; // @[CoreTop.scala 124:24]
  assign memory_io_unsigned = CU_io_unsigned; // @[CoreTop.scala 126:22]
  assign memory_io_data_width = memInSelector_io_data_width; // @[CoreTop.scala 123:24]
  assign memory_io_data_addr = memInSelector_io_data_addr; // @[CoreTop.scala 121:23]
  assign memory_io_data_write = memInSelector_io_data_write; // @[CoreTop.scala 122:24]
  assign memory_io_external_btn_button = io_external_btn_button; // @[CoreTop.scala 127:22]
  assign memory_io_external_switches_switches = io_external_switches_switches; // @[CoreTop.scala 127:22]
  ...
  assign memInSelector_io_cpu_state = state_io_cpu_state; // @[CoreTop.scala 49:30]
  assign memInSelector_io_uart_in_mem_write = uartLoader_io_mem_mem_write; // @[CoreTop.scala 50:28]
  assign memInSelector_io_uart_in_data_to_write = uartLoader_io_mem_data_to_write; // @[CoreTop.scala 50:28]
  assign memInSelector_io_uart_in_data_addr = uartLoader_io_mem_data_addr; // @[CoreTop.scala 50:28]
  assign memInSelector_io_cpu_write_data = CU_io_memory_write; // @[CoreTop.scala 53:35]
  assign memInSelector_io_cpu_data_width = CU_io_data_width; // @[CoreTop.scala 54:35]
  assign memInSelector_io_cpu_data_addr = ALU_io_result; // @[CoreTop.scala 55:34]
  assign memInSelector_io_cpu_data_write = regs_io_rs2_val; // @[CoreTop.scala 56:35]
  assign state_clock = clock;
  assign state_reset = reset;
  assign state_io_load_mode = io_external_signal_load_data_mode; // @[CoreTop.scala 63:22]
  assign pc_clock = clock;
  assign pc_reset = reset;
  assign pc_io_cpu_state = state_io_cpu_state; // @[CoreTop.scala 66:19]
  assign pc_io_next_addr = nextPCGen_io_nextPC; // @[CoreTop.scala 67:19]
  assign insDecode_io_instruction = memory_io_ins_out; // @[CoreTop.scala 71:28]
  assign CU_io_opcode = insDecode_io_opcode; // @[CoreTop.scala 72:16]
  assign CU_io_func3 = insDecode_io_func3; // @[CoreTop.scala 73:15]
  assign CU_io_func7 = insDecode_io_func7; // @[CoreTop.scala 74:15]
  assign CU_io_rs1 = insDecode_io_rs1; // @[CoreTop.scala 75:13]
  assign CU_io_rs2 = insDecode_io_rs2; // @[CoreTop.scala 76:13]
  assign CU_io_rd = insDecode_io_rd; // @[CoreTop.scala 77:12]
  assign CU_io_raw_imm = insDecode_io_raw_imm; // @[CoreTop.scala 78:17]
  assign regs_clock = clock;
  assign regs_reset = reset;
  assign regs_io_cpu_state = state_io_cpu_state; // @[CoreTop.scala 82:21]
  assign regs_io_write = CU_io_regs_write; // @[CoreTop.scala 144:17]
  assign regs_io_rs1 = CU_io_rs1_out; // @[CoreTop.scala 83:15]
  assign regs_io_rs2 = CU_io_rs2_out; // @[CoreTop.scala 84:15]
  assign regs_io_rd = CU_io_rd_out; // @[CoreTop.scala 85:14]
  assign regs_io_write_data = writeDataSelector_io_write_data; // @[CoreTop.scala 145:22]
  assign immGen_io_raw_imm = CU_io_raw_imm_out; // @[CoreTop.scala 90:21]
  assign immGen_io_unsigned = CU_io_unsigned; // @[CoreTop.scala 91:22]
  assign immGen_io_imm_width = CU_io_imm_width_type; // @[CoreTop.scala 92:23]
  assign operandSelector_io_rs1_val = regs_io_rs1_val; // @[CoreTop.scala 95:30]
  assign operandSelector_io_rs2_val = regs_io_rs2_val; // @[CoreTop.scala 96:30]
  assign operandSelector_io_real_imm = immGen_io_real_imm; // @[CoreTop.scala 97:31]
  assign operandSelector_io_operand2Type = CU_io_operand2_type; // @[CoreTop.scala 98:35]
  assign ALU_io_operand1 = operandSelector_io_operand1; // @[CoreTop.scala 101:19]
  assign ALU_io_operand2 = operandSelector_io_operand2; // @[CoreTop.scala 102:19]
  assign ALU_io_alu_op = CU_io_alu_type; // @[CoreTop.scala 103:17]
  assign ALU_io_unsigned = CU_io_unsigned; // @[CoreTop.scala 104:19]
  assign CMP_io_operand1 = operandSelector_io_operand1; // @[CoreTop.scala 107:19]
  assign CMP_io_operand2 = operandSelector_io_operand2; // @[CoreTop.scala 108:19]
  assign CMP_io_cmp_op = CU_io_cmp_type; // @[CoreTop.scala 109:17]
  assign CMP_io_unsigned = CU_io_unsigned; // @[CoreTop.scala 110:19]
  assign nextPCGen_io_nextPC_type = CU_io_nextPC_type; // @[CoreTop.scala 117:28]
  assign nextPCGen_io_cmp_result = CMP_io_result; // @[CoreTop.scala 113:27]
  assign nextPCGen_io_alu_result = ALU_io_result; // @[CoreTop.scala 114:27]
  assign nextPCGen_io_imm = immGen_io_real_imm; // @[CoreTop.scala 115:20]
  assign nextPCGen_io_pc = pc_io_addr; // @[CoreTop.scala 116:19]
  assign writeDataSelector_io_write_back_type = CU_io_write_back_type; // @[CoreTop.scala 141:40]
  assign writeDataSelector_io_imm = immGen_io_real_imm; // @[CoreTop.scala 136:28]
  assign writeDataSelector_io_mem_out = memory_io_data_out; // @[CoreTop.scala 137:32]
  assign writeDataSelector_io_au_out = auSelector_io_au_out; // @[CoreTop.scala 138:31]
  assign writeDataSelector_io_pc4 = nextPCGen_io_pc4; // @[CoreTop.scala 139:28]
  assign writeDataSelector_io_pcImm = nextPCGen_io_pcImm; // @[CoreTop.scala 140:30]
  assign auSelector_io_au_type = CU_io_au_type; // @[CoreTop.scala 133:25]
  assign auSelector_io_alu_result = ALU_io_result; // @[CoreTop.scala 131:28]
  assign auSelector_io_cmp_result = CMP_io_result; // @[CoreTop.scala 132:28]
endmodule
module Led(
...
module UARTWrapper(
  ...
  input        io_mmio_rxReady
);
  wire  uart_clk; // @[UARTWrapper.scala 32:22]
  wire  uart_rst; // @[UARTWrapper.scala 32:22]
  wire [7:0] uart_s_axis_tdata; // @[UARTWrapper.scala 32:22]
  wire  uart_s_axis_tvalid; // @[UARTWrapper.scala 32:22]
  wire  uart_s_axis_tready; // @[UARTWrapper.scala 32:22]
  wire [7:0] uart_m_axis_tdata; // @[UARTWrapper.scala 32:22]
  wire  uart_m_axis_tvalid; // @[UARTWrapper.scala 32:22]
  wire  uart_m_axis_tready; // @[UARTWrapper.scala 32:22]
  wire  uart_rxd; // @[UARTWrapper.scala 32:22]
  wire  uart_txd; // @[UARTWrapper.scala 32:22]
  wire  uart_tx_busy; // @[UARTWrapper.scala 32:22]
  wire  uart_rx_busy; // @[UARTWrapper.scala 32:22]
  wire  uart_rx_overrun_error; // @[UARTWrapper.scala 32:22]
  wire  uart_rx_frame_error; // @[UARTWrapper.scala 32:22]
  wire [15:0] uart_prescale; // @[UARTWrapper.scala 32:22]
  uart uart ( // @[UARTWrapper.scala 32:22]
    .clk(uart_clk),
    .rst(uart_rst),
  ...
  assign io_board_tx = uart_txd; // @[UARTWrapper.scala 41:17]
  assign io_mmio_rxData = uart_m_axis_tdata; // @[UARTWrapper.scala 43:20]
  assign io_mmio_rxValid = uart_m_axis_tvalid; // @[UARTWrapper.scala 44:21]
  assign uart_clk = clock; // @[UARTWrapper.scala 33:26]
  assign uart_rst = reset; // @[UARTWrapper.scala 34:26]
  assign uart_s_axis_tdata = 8'h0; // @[UARTWrapper.scala 36:26]
  assign uart_s_axis_tvalid = 1'h0; // @[UARTWrapper.scala 37:27]
  assign uart_m_axis_tready = io_mmio_rxReady; // @[UARTWrapper.scala 45:27]
  assign uart_rxd = io_board_rx; // @[UARTWrapper.scala 40:17]
  assign uart_prescale = 16'h516; // @[UARTWrapper.scala 47:22]
endmodule
module DeviceTop(
  input         clock,
  input         reset,
  ...
  wire  uart_io_mmio_rxReady; // @[DeviceTop.scala 46:20]
  ...
  UARTWrapper uart ( // @[DeviceTop.scala 46:20]
    ...
    .io_mmio_rxReady(uart_io_mmio_rxReady)
  );
  ...
  assign uart_io_mmio_rxReady = io_mmio_uart_rxReady; // @[DeviceTop.scala 52:16]
endmodule
module Top(
  input         clock,
  input         reset,
  ...
  wire  cpu_io_external_uart_rxReady; // @[Top.scala 17:11]
  ...
  wire  device_io_mmio_uart_rxReady; // @[Top.scala 19:22]
  ...
  CoreTop cpu ( // @[Top.scala 17:11]
    ...
    .io_external_uart_rxReady(cpu_io_external_uart_rxReady),
  ...
  DeviceTop device ( // @[Top.scala 19:22]
    ...
    .io_mmio_uart_rxReady(device_io_mmio_uart_rxReady),
  ...
  assign device_io_mmio_uart_rxReady = cpu_io_external_uart_rxReady; // @[Top.scala 25:18]

...
void Vcounter::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+3,(vlTOPp->out),8);
        tracep->chgCData(oldp+4,(vlTOPp->counter__DOT__count_reg),8);
        tracep->chgCData(oldp+5,(vlTOPp->counter__DOT__next_count_reg),8);
    }
}

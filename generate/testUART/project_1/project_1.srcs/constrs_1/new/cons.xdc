...
set_property IOSTANDARD LVCMOS33 [get_ports io_board_rx]
set_property IOSTANDARD LVCMOS33 [get_ports io_board_tx]
set_property IOSTANDARD LVCMOS33 [get_ports io_signal]
